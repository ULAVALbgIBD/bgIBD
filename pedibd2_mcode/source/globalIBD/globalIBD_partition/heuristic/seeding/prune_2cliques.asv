...
function [final_p_clique, final_m_clique, final_pm_clique] = prune_2cliques(index, neighbor12, ibd12, p_clique_forced, p_clique_expanded, m_clique_forced, m_clique_expanded, vote_both, posterior, tolerance)
